...
print(len(all_gears))
print(sum(map(lambda x: 1 if '*' in x else 0, "\n".join(data))))

for loc, gear in all_gears.items():
    if len(gear) == 2:
        # print(loc)
        summ += gear[0] * gear[1]
